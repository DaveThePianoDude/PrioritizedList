...
namespace OutlineTransformer
{
    public class Tools
    {
        ...
        static string ioPath = "..\\..\\..\\PrioritizedListTransformer\\Docs\\";
        ...
        public static void ConvertOutlineToXml(string input, string output)
        {
            ...
            System.IO.StreamWriter outputFile = new System.IO.StreamWriter(ioPath + output);

            // Read the file and display it line by line.
            System.IO.StreamReader file = new System.IO.StreamReader(ioPath + input);
